...
<html>
    ...
    <body>
        <p>
        Nobody’s born <em>smart</em>. We all start at 0. Can’t talk, can’t walk, certainly can’t do algebra.<br>
        ...
        <strong>Thankfully, we are born to learn.<br>
        ...
        One foot in front of the other.</strong> One idea on top of the next.<br>
        Each wrong answer making your brain a little bit stronger.<br>
        <strong>Failing is just <em>another word</em> for growing.</strong> And you keep going.<br>
        This. is. learning.<br>
